...
//import com.momo.member.DumpMember;
...
//                   .placeTitle("여기가 존맛 맛집!")
//                   .placeContent("분위기도 좋고 깔끔하고 일단 맛이 최고!")
//                   .placeId("스타벅스 강남점")
//                   .placeLat("37.506229157876774")
//                   .placeLng("127.05688880326076")
//                   .board.setBoardNum(1)
//                   .member.setMemId((long) 2)
//                   .build());
//                
//                Board board1 = boardRepository.save(Board.builder()
//                		.boardTitle("오늘은 여기서 먹을까?")
//                		.member.getMemEmail("aaaa@aaaa.com")
//  
//           }}
